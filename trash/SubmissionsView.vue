...
async function fetchSubmissions() {
  try {
    ...
    console.log(r.data)
    const f = await axios.get("/api/submissions/fields/");
    submissionsFields.value = f.data;

    submissionsFields.value.forEach((field) => {
...
async function onRemoveClick(student) {
  try {
    await axios.delete(`/api/submissions/${student.id}/`);
...
async function onLessonNameEditClick() {
  try {
    ...
    await axios.put(`/api/submissions/${submissionToEdit.value.id}/`, {
...
<template>
  <div>
        ...
        <div class="row">
          <div class="col">
            <div class="form-floating">
              <div
                v-for="item in submissionsFields"
                :key="item.id"
                class="student-item"
              >
    ...
    <div class="edit-frame">
      <div v-for="item in submissions" :key="item.id" class="student-item">
        <div>{{ item.status }}</div>
        <button
